...
import { getMyself } from '../../epics-reducers/services/xacminhthongtinServices';
...
class MyselfTab extends React.Component {
  constructor(props) {
    super(props);
  ...
  onGetRecords = async () => {
    try {
      ...
      const responseData = await getMyself(this.page, 10, requestParams);
...
export default withNavigation(MyselfTab);
