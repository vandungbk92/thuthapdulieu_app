...
export default class DichbenhThanhhoa extends React.Component {
    ...
    return {
      ...
      headerTitle: () => (
        <RkText rkType="header4" style={styleContainer.headerTitle}>
          {I18n.t('Tình hình dịch bệnh Thanh Hóa')}
        </RkText>
      ),
    };
  };
  ...
  render() {
    return (
      <View style={styleContainer.containerContent}>
        <WebView
          source={{
            uri: 'http://covid19.thanhhoa.gov.vn/tinh-hinh-dich-benh.aspx',
          }}
          renderLoading={() => (
