...
import {
    postFile,
    postImages,
} from "../../epics-reducers/services/fileServices";
import {
    getAllDataset,
    getUserInfo,
...
class UploadScreen extends React.Component {
    ...
    onFormSubmit = async () => {
        try {
            ...
            console.log(hinhanh, video, audio);
            if (hinhanh.length || video.length || audio.length) {
                let dataReq = {
                ...
                <ScrollView style={tw.p4}>
                    <FormGroup
                        ...
                        onConfirm={(id, selected) => {
                            this.setState({ datasetId: selected[0]._id });
                        }}
                    />
