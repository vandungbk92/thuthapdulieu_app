...
import { getAll } from '../../epics-reducers/services/noisoiHongServices';
...
export default class NoisoiHong extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      ...
      headerRight: () => (
        <TouchableOpacity
          style={styleContainer.headerButton}
          onPress={() => navigation.navigate(NOISOI_HONG_FILTER, params)}
        >
  ...
  renderItem = ({ item }) => (
    <TouchableOpacity
      onPress={() => this.props.navigation.navigate(NOISOI_HONG_DETAIL, item)}
    >
      ...
      <View style={styleContainer.containerContent}>
        ...
        <View style={[tw.absolute, tw.p4, tw.bottom0, tw.right0]}>
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate(NOISOI_HONG_CREATE)}
          >
            <Ionicons
              name="ios-add"
              size={26}
