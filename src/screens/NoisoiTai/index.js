...
export default class NoisoiTai extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      ...
      headerRight: () => (
        <TouchableOpacity
          style={styleContainer.headerButton}
          onPress={() => navigation.navigate(NOISOI_TAI_FILTER, params)}
        >
  ...
  renderItem = ({ item }) => (
    <TouchableOpacity
      onPress={() => this.props.navigation.navigate(NOISOI_TAI_DETAIL, item)}
    >
      ...
      <View style={styleContainer.containerContent}>
        ...
        <View style={[tw.absolute, tw.p4, tw.bottom0, tw.right0]}>
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate(NOISOI_TAI_CREATE)}
          >
            <Ionicons
              name="ios-add"
              size={26}
