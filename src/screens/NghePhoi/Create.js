...
import { createData } from '../../epics-reducers/services/nghephoiServices';

import KeyboardAwareScrollView from '@pietile-native-kit/keyboard-aware-scrollview';

export default class NghePhoiCreate extends React.Component {
    ...
    return {
      ...
      headerTitle: () => (
        <RkText rkType="header4" style={styleContainer.headerTitle}>
          {I18n.t('Thu thập dữ liệu nghe phổi')}
        </RkText>
      ),
    };
  };
  ...
  onFormSubmit = async () => {
    ...
    if (responseData) {
      showToast('Gửi dữ liệu thu thập nghe phổi thành công');
      this.props.navigation.navigate(NGHE_PHOI, { forceRefresh: true });
    }
  };
